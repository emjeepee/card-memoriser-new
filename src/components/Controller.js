...
someObject also contains:
i)    array availableCards, which lists the 52 svgs that represent the cards of a deck
...
// so this.playPack now includes 54 cards, 52 of which are randomly
// positioned in the array (ie the pack is shuffled!):
